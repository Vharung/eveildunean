 ...
 * @extends {Actor}
 */
 export class neanActorSheet extends ActorSheet {
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
          classes: ["nean", "sheet", "actor"],
          //template: "systems/nean/templates/actor/personnage-sheet.html",
          width: 1245,
          height: 820,
    ...
    console.log(armetoile)
        ...
        if(this.actor.type=="vehicule"){
            ...
            if(type==1){
                html.find('.types').val(game.i18n.localize("neansf.type1"));
            }else if(type==2){
                html.find('.types').val(game.i18n.localize("neansf.type2"));
            }else if(type==3){ 
                html.find('.types').val(game.i18n.localize("neansf.type3"));
            }else if(type==4){
                html.find('.types').val(game.i18n.localize("neansf.type4"));
            }
            if(tail==1){
                html.find('.tailles').val(game.i18n.localize("neansf.taille1"));
            }else if(tail==2){
                html.find('.tailles').val(game.i18n.localize("neansf.taille2"));
            }else if(tail==3){
                html.find('.tailles').val(game.i18n.localize("neansf.taille3"));
            }else if(tail==4){
                html.find('.tailles').val(game.i18n.localize("neansf.taille4"));
            }
            ...
            html.find( ".item-valeur" ).each(function( index ) {
                if($( this ).text()!=game.i18n.localize('neansf.l4')){
                    prix.push($( this ).text());
                }
            ...
            html.find( ".item-qt" ).each(function( index ) {
                if($( this ).text()!=game.i18n.localize('neansf.l6')){
        ...
        if(agi >=30 && dex >=30){
            html.find('.titreaction').html(game.i18n.localize("neansf.action2"))
        }
        ...
        html.find( ".refbar" ).each(function( index ) {
          ...
          if(pc>'60'){
            ...
            $('.z'+z).css({'background':' url(systems/neansf/assets/icon/'+t+'1.png) center center no-repeat'});
          }else if(pc>'30'){
            $('.zone.'+name+' .bar').css({'background':'#c9984b','width':pc+'%'});
            $('.z'+z).css({'background':' url(systems/neansf/assets/icon/'+t+'2.png) center center no-repeat'});
          }else if(pc<=0){
            $('.zone.'+name+' .bar').css({'background':'#460000','width':pc+'%'});
            $('.z'+z).css({'background':' url(systems/neansf/assets/icon/'+t+'0.png) center center no-repeat'});
          }else{
            $('.zone.'+name+' .bar').css({'background':'#a10001','width':pc+'%'});
            $('.z'+z).css({'background':' url(systems/neansf/assets/icon/'+t+'3.png) center center no-repeat'});
          }
        });
        ...
        if(hp<=0){
            ...
            html.find('.santes').css({"background": "url(systems/neansf/css/biohazard.jpg) center center","background-size":"80% 80%","background-repeat": "no-repeat"});
        }else {
    ...
    _onAvantageRace(event){
        ...
        var bonusrace='';
        if(clanliste==game.i18n.localize("neansf.humain")){
            bonusrace="10 Dextérité et solidarité entre humain";
        }else if(clanliste==game.i18n.localize("neansf.artu")){
            bonusrace="10 Connaissance générale et Kamikaze";
        }else if(clanliste==game.i18n.localize("neansf.dragon")){
            bonusrace="10 Force et récupération rapide (+5PV /jour)";
        }else if(clanliste==game.i18n.localize("neansf.machine")){
            bonusrace="10 Piratage et accès au réseau intermachine";
        }else if(clanliste==game.i18n.localize("neansf.pleiadiens")){
            bonusrace="10 Pistage et capacité de résurrection";
        }else if(clanliste==game.i18n.localize("neansf.yor")){
            bonusrace="10 Perception et sixième sens";
        }else if(clanliste==game.i18n.localize("neansf.elf")){
            bonusrace="10 Agilité et Technophile";
        }else if(clanliste==game.i18n.localize("neansf.orqu")){
    ...
    _onAvantageJob(event){
        ...
        var metier='';
        if(metierliste==game.i18n.localize("neansf.metier1")){
            metier="10 Artisanat";
        }else if(metierliste==game.i18n.localize("neansf.metier2")){
            metier="10 Négociation";
        }else if(metierliste==game.i18n.localize("neansf.metier3")){
            metier="10 Survie";
        }else if(metierliste==game.i18n.localize("neansf.metier4")){
            metier="10 Investigation";
        }else if(metierliste==game.i18n.localize("neansf.metier5")){
            metier="10 Discrétion";
        }else if(metierliste==game.i18n.localize("neansf.metier6")){
            metier="10 Pilote";
        }else if(metierliste==game.i18n.localize("neansf.metier7")){
            metier="10 Médecine";
        }else if(metierliste==game.i18n.localize("neansf.metier8")){
            metier="10 Tir";
        }else if(metierliste==game.i18n.localize("neansf.metier9")){
            metier="10 Mécanique";
        }else if(metierliste==game.i18n.localize("neansf.metier10")){
            metier="10 Science";
        }else if(metierliste==game.i18n.localize("neansf.metier11")){
            metier="10 Magie";
        }
        console.log(metier)
    ...
    _onAleatoire(event){
        ...
        var img='systems/neansf/assets/icon/monstre.jpg';
    ...
    _onVehi(event){
        ...
        if(type==1){
            prix=650;types=game.i18n.localize("neansf.type1");
        }else if(type==2){
            prix=350;types=game.i18n.localize("neansf.type2");
        }else if(type==3){
            prix=850;types=game.i18n.localize("neansf.type3");
        }else if(type==4){
            prix=5500;types=game.i18n.localize("neansf.type4");
        }
        if(tail==1){
            prix=prix+prix*(parseInt(ia)+parseInt(mote)+parseInt(blin));tailles=game.i18n.localize("neansf.taille1");
        }else if(tail==2){
            prix=prix+prix*(2+parseInt(ia)*2+parseInt(mote)*2+parseInt(blin)*2);pv=pv*2;nbequi=nbequi*2;nbpiece=nbpiece+2;tailles=game.i18n.localize("neansf.taille2");
        }else if(tail==3){
            prix=prix+prix*(3+parseInt(ia)*3+parseInt(mote)*3+parseInt(blin)*3);pv=pv*4;nbequi=nbequi*3;nbpiece=nbpiece+4;tailles=game.i18n.localize("neansf.taille3");
        }else if(tail==4){
            prix=prix+prix*(100+parseInt(ia)*5+parseInt(mote)*5+parseInt(blin)*5);pv=pv*8;nbequi=nbequi=100;nbpiece=100;tailles=game.i18n.localize("neansf.taille4");
        }
        var ptrestant=0;
        if(ia=="0.5"){
            ptrestant=60;
    ...
    _onEarth(event){
        ...
        var img='systems/neansf/assets/planete/p'+Math. round(Math.random() * 16)+'.png';
    ...
    async _onStatM(event){
        ...
        if(level==1){
            for (var i = cpt.length - 1; i >= 0; i--) {
                if(metier==game.i18n.localize("neansf.metier1") && i==1 || 
                   metier==game.i18n.localize("neansf.metier2") && i==16|| 
                   metier==game.i18n.localize("neansf.metier3") && i==23|| 
                   metier==game.i18n.localize("neansf.metier4") && i==10|| 
                   metier==game.i18n.localize("neansf.metier5") && i==8 || 
                   metier==game.i18n.localize("neansf.metier6") && i==18|| 
                   metier==game.i18n.localize("neansf.metier7") && i==13|| 
                   metier==game.i18n.localize("neansf.metier8") && i==24|| 
                   metier==game.i18n.localize("neansf.metier9") && i==12|| 
                   metier==game.i18n.localize("neansf.metier10") && i==22|| 
                   metier==game.i18n.localize("neansf.metier11") && i==26||
                   race==game.i18n.localize("neansf.humain") && i==6 ||
                   race==game.i18n.localize("neansf.artu") && i==4 || 
                   race==game.i18n.localize("neansf.pleiadiens") && i==20 || 
                   race==game.i18n.localize("neansf.yor") && i==17 || 
                   race==game.i18n.localize("neansf.dragon") && i==9 || 
                   race==game.i18n.localize("neansf.elf") && i==0 || 
                   race==game.i18n.localize("neansf.machine") && i==19 || 
                   race==game.i18n.localize("neansf.orqu") && i==3){
        ...
        if(parseInt(level)>1){
            for (var i = cpt.length - 1; i >= 0; i--) {
                if(race==game.i18n.localize("neansf.humain") && i==6 ||
                   race==game.i18n.localize("neansf.artu") && i==4 || 
                   race==game.i18n.localize("neansf.pleiadiens") && i==20 || 
                   race==game.i18n.localize("neansf.yor") && i==17 || 
                   race==game.i18n.localize("neansf.dragon") && i==9 || 
